...
const FloatingQuoteButton = () => {
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className="fixed right-4 bottom-6 z-40 flex items-center justify-center w-14 h-14 bg-[#25D366] text-white rounded-full shadow-lg hover:opacity-90 transition-all hover:scale-105"
