...
import ServiceDetailDialog, { type ServiceFAQ } from "./ServiceDetailDialog";
...
const ServiceCard = ({ title, description, image, price, features, faqs, index }: ServiceCardProps) => {
